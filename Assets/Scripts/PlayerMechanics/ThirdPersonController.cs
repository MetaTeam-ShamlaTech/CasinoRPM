...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private GameObject _mainCamera, avatar;
        ...
        private void Start()
        {
            ...
            {
                StarterAssetsInputs.CursorToggle(true);
        ...
        private void OnAvatarLoadCompleted(object sender, CompletionEventArgs args)
        {
            ...
            avatar.transform.SetLocalPositionAndRotation(Vector3.zero, Quaternion.Euler(Vector3.zero));
